        ...
        <section className='flex flex-col gap-6 lg:justify-evenly lg:flex-row p-5'>
            {dataService?.map((data) => (
                <React.Fragment key={data.id}>
                    <div className='flex max-lg:text-center flex-col self-center w-full max-sm:max-w-xs lg:max-w-xs max-w-lg p-4 bg-white border border-gray-200 rounded-lg hover:shadow-custom duration-1000 sm:p-8 dark:bg-gray-800 dark:border-gray-700' style={{ "height": 450 }}><h5>{data.fullName}</h5>
                        ...
                        <ul role="list" className="space-y-4 max-lg:space-y-6 my-7 h-full text-start">
